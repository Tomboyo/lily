...
class OasSchemaToAstTest {
          ...
          new Pair<>(
              ...
              Set.of(
                  AstClass.of(
                      ...
                      List.of(
                          new AstField(
                              of(Fqn.of("p.myobject", "MyInnerObject"), List.of()),
          ...
          new Pair<>(
              ...
              Set.of(
                  AstClass.of(
                      ...
                      List.of(
                          new AstField(
                              of(Fqn.of("p", "MyRef"), List.of()), SimpleName.of("myField")))))),
          actual.mapRight(stream -> stream.collect(toSet())),
              ...
              Set.of(
                  AstClass.of(
                      ...
                      List.of(
                          ...
                          new AstField(
                              of(Fqn.of("p", "MyRef"), List.of()), SimpleName.of("myField2")))))),
          actual.mapRight(stream -> stream.collect(toSet())),
  ...
  class ArraySchemas {
    ...
    void evaluateWithInlineObjectItem() {
      ...
      assertEquals(
          new Pair<>(
              astListOf(of(Fqn.of("p", "MyArrayItem"), List.of())),
              Set.of(
                  AstClass.of(
    ...
    void evaluateWithReferenceItem() {
      ...
      assertEquals(
          new Pair<>(astListOf(of(Fqn.of("p", "MyRef"), List.of())), Set.of()),
          actual.mapRight(stream -> stream.collect(toSet())),
