...
public class Encoding {
  ...
  private static final ObjectMapper mapper = new ObjectMapper(new SimpleFactory());
  ...
  private static class SimpleFactory extends JsonFactory {
    @Override
  ...
  public static class SimpleGenerator extends GeneratorBase {
